...
public class CentralIndex
{
  ...
  */
   ...
   *  @return - the data from the api
  */
  public String putBusiness( String name, String building_number, String branch_name, String address1, String address2, String address3, String district, String town, String county, String province, String postcode, String country, String latitude, String longitude, String timezone, String telephone_number, String allow_no_phone, String additional_telephone_number, String email, String website, String category_id, String category_type, String do_not_display, String referrer_url, String referrer_name, String destructive, String delete_mode, String master_entity_id) {
    Hashtable p = new Hashtable();
    p.Add("name",name);
  ...
  */
   ...
   *  @return - the data from the api
  */
  public String postEntityAnnouncement( String entity_id, String headline, String body, String link_label, String link, String terms_link, String expiry_date, String media_type, String youtube_embed_code, String image_url, String filedata, String type) {
    Hashtable p = new Hashtable();
    p.Add("entity_id",entity_id);
    p.Add("headline",headline);
    p.Add("body",body);
  ...
  */
   ...
   *  @return - the data from the api
  */
  public String getLeadsAdded( String country_id, String from_date, String to_date, String limit, String offset) {
    Hashtable p = new Hashtable();
    p.Add("country_id",country_id);
    p.Add("from_date",from_date);
    p.Add("to_date",to_date);
   ...
   *  @return - the data from the api
  */
  public String getLeadsAdvertisers( String country_id, String from_date, String to_date, String limit, String offset) {
    Hashtable p = new Hashtable();
    p.Add("country_id",country_id);
    p.Add("from_date",from_date);
    p.Add("to_date",to_date);
   ...
   *  @return - the data from the api
  */
  public String getLeadsClaimed( String country_id, String from_date, String to_date, String limit, String offset) {
    Hashtable p = new Hashtable();
    p.Add("country_id",country_id);
    p.Add("from_date",from_date);
    p.Add("to_date",to_date);
  ...
  */
   ...
   *  @return - the data from the api
  */
  public String postPaintBy_ingest_job_id( String ingest_job_id) {
    Hashtable p = new Hashtable();
  ...
  */
   ...
   *  @return - the data from the api
  */
  public String postPlugin( String id, String slug, String owner, String scope, String status) {
    Hashtable p = new Hashtable();
    p.Add("id",id);
    p.Add("slug",slug);
    p.Add("owner",owner);
   ...
   *  @return - the data from the api
  */
  public String postPluginActivate( String entity_id, String plugin, String expiry_date) {
    Hashtable p = new Hashtable();
    p.Add("entity_id",entity_id);
    p.Add("plugin",plugin);
    p.Add("expiry_date",expiry_date);
  ...
  */
   ...
   *  @return - the data from the api
  */
  public String getTokenAdd( String language, String portal_name, String partner, String country, String flatpack_id) {
    Hashtable p = new Hashtable();
    p.Add("language",language);
