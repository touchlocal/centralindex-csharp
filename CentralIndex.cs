...
public class CentralIndex
{
  ...
  */
   ...
   *  @return - the data from the api
  */
  public String getAdvertiserUpdatedBy_publisher( String from_date, String country) {
    Hashtable p = new Hashtable();
    p.Add("from_date",from_date);
    p.Add("country",country);
  ...
  */
   ...
   *  @return - the data from the api
  */
  public String getAutocompleteLocz( String str, String country, String language) {
    Hashtable p = new Hashtable();
    p.Add("str",str);
    p.Add("country",country);
    p.Add("language",language);
    return doCurl("GET","/autocomplete/locz",p);
  }
   ...
   *  @return - the data from the api
  */
  public String getAutocompleteLoczBy_resolution( String str, String country, String resolution, String all_data) {
    Hashtable p = new Hashtable();
    p.Add("str",str);
    p.Add("country",country);
    p.Add("resolution",resolution);
    p.Add("all_data",all_data);
    return doCurl("GET","/autocomplete/locz/by_resolution",p);
  }
  ...
  */
   ...
   *  @return - the data from the api
  */
  public String postLocationSynonymBulk( String filedata) {
    Hashtable p = new Hashtable();
    p.Add("filedata",filedata);
    return doCurl("POST","/location/synonym/bulk",p);
  }
  ...
  */
   ...
   *  @return - the data from the api
  */
  public String getLocz( String location_id) {
    Hashtable p = new Hashtable();
    p.Add("location_id",location_id);
    return doCurl("GET","/locz",p);
  }
   ...
   *  @return - the data from the api
  */
  public String getLoczMultiple( String location_ids) {
    Hashtable p = new Hashtable();
    p.Add("location_ids",location_ids);
    return doCurl("GET","/locz/multiple",p);
  }
  ...
  */
   ...
   *  @return - the data from the api
  */
  public String getLookupLocz( String _string, String language, String country, String latitude, String longitude) {
    Hashtable p = new Hashtable();
    p.Add("string",_string);
    p.Add("language",language);
    p.Add("country",country);
    p.Add("latitude",latitude);
    p.Add("longitude",longitude);
    return doCurl("GET","/lookup/locz",p);
  }
  ...
  */
   ...
   *  @return - the data from the api
  */
  public String postSales_log( String entity_id, String country, String action_type, String publisher_id, String mashery_id, String reseller_ref, String reseller_agent_id, String max_tags, String max_locations, String extra_tags, String extra_locations, String expiry_date) {
    Hashtable p = new Hashtable();
    p.Add("entity_id",entity_id);
    p.Add("country",country);
  ...
  */
   ...
   *  @return - the data from the api
  */
  public String postUser( String email, String first_name, String last_name, String active, String trust, String creation_date, String user_type, String social_network, String social_network_id, String reseller_admin_masheryid, String group_id, String admin_upgrader) {
    Hashtable p = new Hashtable();
    p.Add("email",email);
